...
public class Principal {
        ...
        while (opcao != 0){
            ...
            switch (opcao) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    buscarSeriePorTemporadaEAvaliação();
                    break;
                case 9:
    ...
    private void listarSeriebuscadas(){
        ...
        series = repositorio.findAll(); //vai no repositório e pega todos já cadastrados
        series.stream()
    ...
    private void buscarSeriePorTemporadaEAvaliação() {
